import svgPaths from "./svg-txj0xpkrdi";
...
/**
 * @figmaAssetKey 8ffaa17a1b238b40dab1c17a4b147abb90f9ecd4
 */
    ...
    <div className={className}>
      ...
      <div className="absolute contents inset-0">
        <div className="absolute contents inset-0">
          ...
          <p className="absolute font-['Archivo_Narrow:Medium',sans-serif] font-medium inset-[43.09%_24.14%_42.28%_37.93%] leading-[1.5] text-[12px] text-nowrap text-white tracking-[-0.12px] whitespace-pre">Upload From My Camera</p>
        </div>
        <div className="absolute contents inset-[42.28%_79.02%_41.87%_12.76%]">
...
/**
 * @figmaAssetKey 19b48c618f4e1391b19f35c607fad8e4e6a10f97
 */
...
/**
 * @figmaAssetKey d0892759f906c87ed95359df74daccf79ceb1a44
 */
...
export default function MobileUpload() {
  return (
    <div className="bg-[#291a01] relative size-full" data-name="mobile-upload-2">
      ...
      <Group1 className="absolute h-[123px] left-1/2 top-[584px] translate-x-[-50%] w-[290px]" />
      <Group2 className="absolute h-[123px] left-[calc(50%+308px)] top-[584px] translate-x-[-50%] w-[290px]" />
