...
function Group1({ className }: { className?: string }) {
  return (
    <div className={className}>
      <motion.div 
        className="absolute aspect-[411.743/254.872] flex items-center justify-center left-[65.53%] right-[4.75%] top-[396px] transition-transform duration-300 hover:scale-105 hover:rotate-2"
        animate={{ 
          filter: [
      ...
      <motion.div 
        className="absolute aspect-[389.748/389.748] flex items-center justify-center left-[11.04%] right-[60.83%] top-[11px] transition-transform duration-300 hover:scale-105 hover:-rotate-2"
        animate={{ 
          filter: [
            "drop-shadow(0 0 3px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 12px rgba(255, 0, 255, 0.5))",
      ...
      <motion.div 
        className="absolute aspect-[496.624/496.624] flex items-center justify-center left-[64.16%] right-0 top-0 transition-transform duration-300 hover:scale-105 hover:rotate-3"
        animate={{ 
          filter: [
            "drop-shadow(0 0 3px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 12px rgba(255, 0, 255, 0.5))",
      ...
      <motion.div 
        className="absolute aspect-[397.579/249.086] flex items-center justify-center left-[43.37%] right-[27.93%] top-[81px] transition-transform duration-300 hover:scale-105 hover:-rotate-1"
        animate={{ 
          filter: [
            "drop-shadow(0 0 3px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 12px rgba(255, 0, 255, 0.5))",
      ...
      <motion.div 
        className="absolute aspect-[506.15/346.676] flex items-center justify-center left-0 right-[63.47%] top-[330px] transition-transform duration-300 hover:scale-105 hover:rotate-1"
        animate={{ 
          filter: [
            "drop-shadow(0 0 3px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 12px rgba(255, 0, 255, 0.5))",
      ...
      <motion.div 
        className="absolute aspect-[241.561/236.361] flex items-center justify-center left-[27.79%] right-[54.78%] top-[396px] transition-transform duration-300 hover:scale-105 hover:-rotate-3"
        animate={{ 
          filter: [
            "drop-shadow(0 0 3px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 12px rgba(255, 0, 255, 0.5))",
...
export default function Desktop({ onNavigate, onToggleMenu }: DesktopProps) {
  return (
    <div className="bg-[#291a01] relative size-full" data-name="Desktop - 39">
      <Group2 className="absolute h-[75px] left-[51px] top-[47px] w-[173px] cursor-pointer" onClick={onToggleMenu} />
      <Group className="absolute h-[48px] left-1/2 top-[900px] translate-x-[-50%] w-[442px]" />
