import svgPaths from "./svg-gbayt10u02";
...
function Group6() {
  return (
    <div className="absolute contents left-[57px] top-[584px]">
      <div className="absolute h-[123px] left-[57px] top-[584px] w-[290px]">
...
function Group5() {
  return (
    <div className="absolute contents inset-0">
      ...
      <p className="absolute font-['Archivo_Narrow:Medium',sans-serif] font-medium inset-[43.09%_20.69%_42.28%_42.76%] leading-[1.5] text-[#401b01] text-[12px] text-center text-nowrap tracking-[-0.12px] whitespace-pre">Upload From My Photos</p>
    </div>
  );
}
...
export default function MobileCapture() {
  return (
    <div className="bg-[#291a01] relative size-full" data-name="mobile-capture-2">
      ...
      <Group1 />
      <Group6 />
      <div className="absolute h-[123px] left-[calc(50%-307px)] top-[584px] translate-x-[-50%] w-[290px]">
        <Group5 />
        <Group4 />
      </div>
      <Group8 />
