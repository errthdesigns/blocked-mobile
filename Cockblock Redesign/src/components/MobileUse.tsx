...
import svgPaths from "../imports/svg-7rovb8pav2";
...
function Group1({ className }: { className?: string }) {
  return (
    <div className={className}>
      <motion.div 
        className="absolute aspect-[288.494/178.581] flex items-center justify-center left-[36.94%] right-0 top-[159px]"
        animate={{ 
          filter: [
      ...
      <motion.div 
        className="absolute aspect-[230.556/230.556] flex items-center justify-center left-[5.03%] right-[44.58%] top-0"
        animate={{ 
          filter: [
            "drop-shadow(0 0 2px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 8px rgba(255, 0, 255, 0.5))",
      ...
      >
        <div className="flex-none rotate-[341.519deg] size-[182.198px]">
      ...
      <motion.div 
        className="absolute aspect-[126.989/124.255] flex items-center justify-center left-[18.58%] right-[53.66%] top-[200px]"
        animate={{ 
          filter: [
            "drop-shadow(0 0 2px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 8px rgba(255, 0, 255, 0.5))",
      ...
      >
        <div className="flex-none h-[88.227px] rotate-[330deg] w-[95.696px]">
      ...
      <motion.div 
        className="absolute aspect-[205.072/205.072] flex items-center justify-center left-0 right-[55.17%] top-[196px]"
        animate={{ 
          filter: [
            "drop-shadow(0 0 2px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 8px rgba(255, 0, 255, 0.5))",
      ...
      <motion.div 
        className="absolute aspect-[252.675/158.352] flex items-center justify-center left-[37.81%] right-[6.96%] top-[28px]"
        animate={{ 
          filter: [
            "drop-shadow(0 0 2px rgba(255, 0, 255, 0.3))",
            "drop-shadow(0 0 8px rgba(255, 0, 255, 0.5))",
      ...
      >
        <div className="flex-none h-[101.104px] rotate-[15deg] w-[234.498px]">
      ...
      <motion.div 
        className="absolute aspect-[2791/650] left-[6.56%] right-[6.88%] top-[calc(50%-15.536px)] translate-y-[-50%]" 
        data-name="Layer_1-7"
        animate={{ 
          filter: [
            "drop-shadow(0 0 2px rgba(255, 0, 255, 0.3))",
...
export default function MobileUse({ onNavigate, onToggleMenu, menuExpanded = true, onStartUpload }: MobileUseProps) {
  return (
    <div className="bg-[#291a01] relative size-full" data-name="mobile-use-1">
      {menuExpanded ? (
        <>
          <div className="absolute h-[54px] left-[calc(50%+0.5px)] top-[32px] translate-x-[-50%] w-[349px] cursor-pointer" data-name="mobile-menu 2" onClick={onToggleMenu}>
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgMobileMenu2} />
          </div>
          <div className="absolute flex flex-col font-['Archivo_Narrow:Bold',sans-serif] font-bold h-[47px] justify-center leading-[0] left-[173.5px] text-[#401b01] text-[12px] text-center top-[58.5px] translate-x-[-50%] translate-y-[-50%] w-[49px] cursor-pointer" onClick={() => onNavigate('use')}>
            <p className="leading-[normal]">USE</p>
          </div>
          <div className="absolute flex flex-col font-['Archivo_Narrow:Bold',sans-serif] font-bold h-[47px] justify-center leading-[0] left-[243.5px] text-[#401b01] text-[12px] text-center top-[58.5px] translate-x-[-50%] translate-y-[-50%] w-[49px] cursor-pointer" onClick={() => onNavigate('merch')}>
            <p className="leading-[normal]">MERCH</p>
          </div>
          <div className="absolute flex flex-col font-['Archivo_Narrow:Bold',sans-serif] font-bold h-[47px] justify-center leading-[0] left-[313.5px] text-[#401b01] text-[12px] text-center top-[58.5px] translate-x-[-50%] translate-y-[-50%] w-[49px] cursor-pointer" onClick={() => onNavigate('info')}>
      ...
      >
        <div className="absolute bg-[#ff001b] inset-0 rounded-[25px] cursor-pointer" onClick={onStartUpload}>
      ...
      <Group1 className="absolute h-[401.072px] left-[calc(50%-0.253px)] top-[calc(50%-71.464px)] translate-x-[-50%] translate-y-[-50%] w-[457.494px]" />
      
      <div className="absolute contents left-[32px] top-[585px]">
        <div className="absolute flex flex-col font-['Archivo_Narrow:Bold',sans-serif] font-bold justify-end leading-[0] left-[202px] text-[38px] text-center text-white top-[661px] tracking-[-0.76px] translate-x-[-50%] translate-y-[-100%] w-[340px]">
          <p className="leading-none">Always Use IP Protection</p>
        </div>
      </div>
    </div>
  );
