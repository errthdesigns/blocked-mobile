export default function Mobile1() {
  return (
    <div className="bg-[#291a01] relative size-full" data-name="mobile-1" style={{ minHeight: "100vh", width: "100%" }}>
      ...
      <div className="absolute flex flex-col font-sans font-bold justify-center leading-[0] left-1/2 bottom-10 text-[20px] text-[magenta] text-center text-nowrap tracking-[2px] translate-x-[-50%]">
